...
<body>
    ...
    <div class="max-w-lg mx-auto bg-slate-800 rounded-xl shadow-2xl border border-slate-700 overflow-hidden">
        ...
        <div class="p-8">
            <form action="${createLink(controller: 'main', action: 'save')}" method="POST" id="schoolForm" class="space-y-6" autocomplete="off">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Esta línea SÍ lleva ${} porque es una función de Grails para generar la URL
            ...
            form.addEventListener('submit', function(e) {
                ...
                .then(function(data) {
                    if (data.exito) {
                        ...
                        // --- ERROR (CORREGIDO PARA GSP) ---
                        // Usamos concatenación simple (+) para que Grails NO intente leer variables JS
